...
// using codecrafters_dns_server.DnsMessage;
...
//         var dnsMessage = Parser.ParseDnsMessage(input);
//
//         Assert.That(dnsMessage.Header.AdditionalRecordCount, Is.EqualTo(1234));
//     }
//
//
//     [Test]
...
//         var dnsMessage = Parser.ParseDnsMessage(input);
//
//         Assert.That(dnsMessage.Header.AuthorityRecordCount, Is.EqualTo(1234));
//     }
//
//
//     [Test]
...
//         var dnsMessage = Parser.ParseDnsMessage(input);
//
//         Assert.That(dnsMessage.Header.AnswerRecordCount, Is.EqualTo(1234));
//     }
//
//     [Test]
