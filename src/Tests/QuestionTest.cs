...
public class QuestionTest
{
    ...
    [Test]
    public void TestBytesTwoDots()
    {
        var inputBytes = new byte[]
        {
            0x0c, 0x22, 0x01, 0x20, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x76, 0x75, 0x62, 0x02, 0x61,
            0x63, 0x02, 0x62, 0x65, 0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x01, 0x00, 0x01
        };
        var inputBits = new BitArray(inputBytes);
